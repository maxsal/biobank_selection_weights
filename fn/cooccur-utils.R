...
#   ### logistf
#   if (mod_type == "logistf") {
#     mod <- logistf::logistf(glue::glue("case ~ ",
#                                        "{glue::glue_collapse(c(ex_code, covs),",
#                                        "sep = ' + ')}"),
#                             data = dat)
# 
#     data.table::data.table(
...
# ### DEPRECATED!!! output_mgi_cooccur_results -----------
...
# # SPAtest is *much* faster but logistf allows for inclusion of weights
# output_mgi_cooccur_results <- function(
#     pim_data,
#     cov_data,
#     covariates,
#     t_thresh,
...
#     value.name = "n",
#     id.vars = character())[n >= 10, as.character(phecode)]
# 
#   # 2. merge covariates
